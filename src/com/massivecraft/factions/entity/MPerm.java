...
public class MPerm extends Entity<MPerm> implements Prioritized, Registerable, Named
{
	...
	public final static transient String ID_FHOME = "fhome";
	public final static transient String ID_FSETHOME = "fsethome";
	...
	public final static transient String ID_DELETEWARP = "deletewarp";
	public final static transient String ID_SETWARP = "setwarp";
	public final static transient String ID_SETBANNER = "setbanner";
	public final static transient String ID_GETBANNER = "getbanner";
	public final static transient String ID_USEBANNER = "usebanner";
	...
	public final static transient int PRIORITY_FHOME = 13000;
	public final static transient int PRIORITY_FSETHOME = 14000;
	public final static transient int PRIORITY_HOME = 14010;
	public final static transient int PRIORITY_SETHOME = 14020;
	public final static transient int PRIORITY_WARP = 14100;
	public final static transient int PRIORITY_DELETEWARP = 14200;
	public final static transient int PRIORITY_SETWARP = 14500;
	public final static transient int PRIORITY_SETBANNER = 14600;
	public final static transient int PRIORITY_GETBANNER = 14700;
	public final static transient int PRIORITY_USEBANNER = 14800;
	public final static transient int PRIORITY_ASSIST = 14900;
	...
	public final static transient int PRIORITY_TRUSTED = 17500;
	...
	public static MPerm getPermName() { return getCreative(PRIORITY_NAME, ID_NAME, ID_NAME, "set name", MUtil.set(Rel.LEADER, Rel.COLEADER), false, true, true); }
	...
	public static MPerm getPermHome() { return getCreative(PRIORITY_FHOME, ID_FHOME, ID_FHOME, "teleport to f home", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY), false, true, true); }
	public static MPerm getPermSethome() { return getCreative(PRIORITY_FSETHOME, ID_FSETHOME, ID_FSETHOME, "set the f home", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER), false, true, true); }
	public static MPerm getPermEssHome() { return getCreative(PRIORITY_HOME, ID_HOME, ID_HOME, "teleport a home", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY), false, true, true); }
	public static MPerm getPermEssSethome() { return getCreative(PRIORITY_SETHOME, ID_SETHOME, ID_SETHOME, "set a home", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY), false, true, true); }
	public static MPerm getPermWarp() { return getCreative(PRIORITY_WARP, ID_WARP, ID_WARP, "teleport to a warp", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY), false, true, true); }
	public static MPerm getPermSetwarp() { return getCreative(PRIORITY_SETWARP, ID_SETWARP, ID_SETWARP, "set a warp", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER), false, true, true); }
	public static MPerm getPermDeletewarp() { return getCreative(PRIORITY_DELETEWARP, ID_DELETEWARP, ID_DELETEWARP, "delete a warp", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER), false, true, true); }
	public static MPerm getPermSetbanner() { return getCreative(PRIORITY_SETBANNER, ID_SETBANNER, ID_SETBANNER, "set the banner", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER), false, true, true); }
	public static MPerm getPermGetbanner() { return getCreative(PRIORITY_GETBANNER, ID_GETBANNER, ID_GETBANNER, "get the banner", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT), false, true, true); }
	public static MPerm getPermUsebanner() { return getCreative(PRIORITY_USEBANNER, ID_USEBANNER, ID_USEBANNER, "use your banner", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT), false, true, true); }
	public static MPerm getPermAssist() { return getCreative(PRIORITY_ASSIST, ID_ASSIST, ID_ASSIST, "assist your faction", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT), false, true, true); }
	...
	public static MPerm getPermTrusted() { return getCreative(PRIORITY_TRUSTED, ID_TRUSTED, ID_TRUSTED, "be trusted", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER, Rel.MEMBER), false, true, true); }
	...
	public static MPerm getPermLogin() { return getCreative(PRIORITY_LOGIN, ID_LOGIN, ID_LOGIN, "login territory", MUtil.set(Rel.LEADER, Rel.COLEADER, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY), false, true, true); }
